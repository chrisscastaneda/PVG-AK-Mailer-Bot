...
class Mailchimp {
    ...
    public function __construct($apikey=null, $opts=array()) {
		...
		if (gethostname() == 'jaya-hp')  curl_setopt($this->ch, CURLOPT_SSL_VERIFYPEER, false);  // required for localhost 
        curl_setopt($this->ch, CURLOPT_USERAGENT, 'pvg-MailChimp-PHP/2.0.5');
